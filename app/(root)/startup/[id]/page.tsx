...
const Page = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  // Fallback for playlistResponse.select to prevent null or undefined access
      ...
      <section className="section_container">
        ...
        <div className="space-y-5 mt-10 max-w-4xl mx-auto">
          <div className="flex-between gap-5">
            ...
            >
              ...
              <div>
                ...
                <p className="text-16-medium text-gray-800">
          ...
          {parsedContent ? (
            ...
            <p className="no-result">No Details Provides</p>
          )}
        </div>
